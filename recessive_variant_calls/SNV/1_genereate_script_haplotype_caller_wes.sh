...
# Core IDs
CORE_IDS=("1-00180" "1-00660" "1-03573" "1-03820" "1-06216" "1-08240" "1-14523" "1-14785" "1-15162" "1-15783" "1-02917" "1-04975")
...
bam="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/dna_bam/${id}.bam"
known_site="/storage1/fs1/jin810/Active/References/GRCh38/KNOWN_SITES/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz"
out_bam="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/haplotype_caller/${id}/${id}_realign_BQSR.bam"
hap_vcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/haplotype_caller/${id}/${id}_BQSR_gatk_hapcaller.g.vcf"
table="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/haplotype_caller/${id}/${id}.recal_data.table"


mkdir -p ./results/haplotype_caller/${id}
