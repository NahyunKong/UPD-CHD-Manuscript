...
CORE_IDS=("1-00180" "1-02917" "1-04975") # List for test1
...
Job="20240617_UPD_joint_call_wgs"
...
for core_id in "${CORE_IDS[@]}"; do
    ...
    out_dir="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}"
...
cd /storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}
...
f_vcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/haplotype_caller/wgs/${core_id}_father/${core_id}_father_BQSR_gatk_hapcaller.g.vcf"
m_vcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/haplotype_caller/wgs/${core_id}_mother/${core_id}_mother_BQSR_gatk_hapcaller.g.vcf"
c_vcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/haplotype_caller/wgs/${core_id}_child/${core_id}_child_BQSR_gatk_hapcaller.g.vcf"
out_bcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_joint_call.bcf"
out_vcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_joint_call.vcf"
out_recal="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_joint_call_recal.vcf"
out_tranches="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_recal.tranches"
out_vqsr="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_joint_call_recal_vqsr.vcf.gz"
out_lm_sp_vcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_lm_sp.vcf.gz"
out_reID_vcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_lm_sp_reID.vcf.gz"
out_annot="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_annot"
out_annot_vcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_annot.hg38_multianno.vcf"
filtered_vcf="/storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/${core_id}_annot_filtered.vcf.gz"
...
#rm -r -f /storage1/fs1/jin810/Active/testing/Nahyun/UPD_PROJECT/20240613_recessive_calling/new_try_hg38_upd_20240928/results/joint_call/wgs/${core_id}/GLnexus.DB
